...
url_celebahq    = 'karras2019stylegan-celebahq-1024x1024.pkl'
url_bedrooms    = 'karras2019stylegan-bedrooms-256x256.pkl'
...
def load_Gs(url):
    if url not in _Gs_cache:
        with open(os.path.join(config.cache_dir, url), "rb") as f:
